<footer class="bg-slate-100 border-t border-slate-200 mt-20">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div class="lg:col-span-1">
                <a href="{{ url('/') }}" class="flex items-center space-x-2 mb-4">
                    ...
                    <span class="font-display text-2xl font-bold gradient-text">GameTech</span>
                </a>
                <p class="text-slate-600 text-sm mb-4">
                    Nền tảng mua bán tài khoản game uy tín hàng đầu Việt Nam. Đa dạng game, giá cả hợp lý, giao dịch an toàn.
                </p>
                <div class="flex space-x-4">
                    <a href="#" class="w-10 h-10 bg-white rounded-lg flex items-center justify-center hover:bg-game-accent/10 transition-colors group border border-slate-200">
                        <svg class="w-5 h-5 text-slate-500 group-hover:text-game-accent" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Contact -->
            <div>
                <h4 class="font-heading text-lg font-semibold text-slate-800 mb-4">Liên hệ</h4>
                <ul class="space-y-3">
                    ...
                    <li class="flex items-start space-x-3 text-slate-600">
                        <svg class="w-5 h-5 text-game-accent mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Bottom -->
        <div class="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center">
            <p class="text-slate-500 text-sm mb-4 md:mb-0">
                © 2025 GameTech Game Store. All rights reserved.
            </p>
            <div class="flex items-center space-x-4">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/200px-Visa_Inc._logo.svg.png" alt="Visa" class="h-6 opacity-60 hover:opacity-100 transition-opacity">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/200px-Mastercard-logo.svg.png" alt="Mastercard" class="h-6 opacity-60 hover:opacity-100 transition-opacity">
                <img src="https://upload.wikimedia.org/wikipedia/vi/f/fe/MoMo_Logo.png" alt="MoMo" class="h-6 opacity-60 hover:opacity-100 transition-opacity">
            </div>
        </div>
    </div>
</footer>
